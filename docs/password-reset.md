...
4. Open the app window and check the server log for the temporary password (visible in the desktop console if running in development mode; otherwise check Task Manager → details for the sidecar process, or add a log file).
